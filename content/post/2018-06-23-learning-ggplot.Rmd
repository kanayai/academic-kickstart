...
So, I am learning how to use [ggplot](https://ggplot2.tidyverse.org/reference/). Here is one my first attempts. I am using one of my favourite datasets: the [Anscombe quartet](https://en.wikipedia.org/wiki/Anscombe%27s_quartet)
